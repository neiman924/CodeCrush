...
export const ADD_USER = gql`
  mutation addUser($name: String!, $email: String!, $password: String!, $age: String, $gender:String, $pic:String) {
    addUser(name: $name, email: $email, password: $password, age: $age, gender: $gender, pic: $pic) {
      token
      user {
        _id
        name
